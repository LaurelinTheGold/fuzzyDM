...
for file in name: #foreach file matching name in directory
	...
	if (parsedFileName[1] == "filelist"): #follows proper naming convention
		...
		plt.plot(z, xH, label=(dm+": "+r"$T_{\mathrm{vir}} = 2 \times 10^4$ K"+", $\zeta = 20$"), marker='o', markersize=3, linestyle='none')
...
# plt.show()
plt.savefig("/Users/richardchen/Desktop/summerResearch/2020summer/fiducialIon/completeIon.pdf") #save